...
# ╔═╡ 37488806-f3ec-11ec-1a4e-abd9a37a8730
begin
	using DrWatson
...
# ╔═╡ ad761cf2-cfaf-4186-bec9-6be8eccbde5b
include("../src/sim_results.jl")

# ╔═╡ 97a263af-9126-498a-8c5a-6189e302c39e
c = read_results!("../data/cluster_task-4");

# ╔═╡ eba16612-bb1d-40c0-8ac1-35647a128f14
let

	d= data(deepcopy(c)|>c->@rsubset(c,
		:f_simple == "1+a|s",
		:σs_simple == "1+1*a|s",
		:test != "β",
...
# ╔═╡ 03c1a6e1-46e3-4a4d-a45a-32a7b0a32dfd
let
...
# ╔═╡ 1b86306a-e47a-4014-8b61-b765ccba0b85
md"## Runtime"

# ╔═╡ be8b081a-1192-4d62-b503-0abcb7af206e
let
	...
	#[ylims!.(a.axis,0,400) for a in d.grid]
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "ad91de545add70a19183dfcee292e7ae88a03000"
